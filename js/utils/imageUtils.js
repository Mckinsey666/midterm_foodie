...
const imageUrl = "https://img.freepik.com/free-photo/blue-mountains-famous-tourism-scenery-lijiang_1417-1143.jpg?size=626&ext=jpg";
...
convertToBase64 = (url, imagetype, callback) => {
...
sendBase64ToServer = (name, base64) => {
    /*
...
uploadImage(imageUrl, "test", 'image/jpeg');